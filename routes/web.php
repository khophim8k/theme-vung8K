...
use Kho8k\ThemeVung\Controllers\ThemeVungController;
...
Route::group([
    ...
    Route::post(sprintf('/%s/{movie}/{episode}/report', config('Kho8k.routes.movie', 'phim')), [ThemeVungController::class, 'reportEpisode'])->name('episodes.report');
    Route::post(sprintf('/%s/{movie}/rate', config('Kho8k.routes.movie', 'phim')), [ThemeVungController::class, 'rateMovie'])->name('movie.rating');
