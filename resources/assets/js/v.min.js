        ...
        t.exports = function (t) {
          return "string" == typeof t && t
            ? ((t = t.replace(s, "").replace(a, "")),
              e.JSON && JSON.parse
                ? JSON.parse(t)
                : r.test(t.replace(n, "@").replace(o, "]").replace(i, ""))
      ...
      (b.$slides = b.$slider
        ...
        (b.$slideTrack =
          0 === b.slideCount
            ...
            : b.$slides.wrapAll('<div class="slick-track" aria-labelledby="slide-recommend"/>').parent()),
        (b.$list = b.$slideTrack
...
(function ($, undefined) {
  $.fn.jRate = function (options) {
      ...
      switch (settings["shape"]) {
        ...
        case "FOOD":
          shapeRate =
            ...
            'c0-9.183,7.444-16.631,16.632-16.631c9.188,0,16.625,7.447,16.625,16.631C41.63,28.576,36.816,34.828,30.155,37z"/>' +
            "</svg>";
          break;
        case "TWITTER":
          shapeRate =
            ...
            +settings.transparency +
            ';stroke-width:0.7px;"' +
            'd="M512,97.209c-18.838,8.354-39.082,14.001-60.33,16.54c21.687-13,38.343-33.585,46.187-58.115' +
        ...
        case "BULB":
          shapeRate =
            ...
            +settings.transparency +
            ';stroke-width:0.7px;"' +
            'd="M384,192c0,64-64,127-64,192H192c0-63-64-128-64-192c0-70.688,57.313-128,128-128S384,121.313,384,192z M304,448h-96' +
        ...
        case "BASKET":
          shapeRate =
            ...
            'c-0.29-0.303-0.472-0.727-0.472-1.193c0-0.464,0.182-0.888,0.472-1.193C23.132,25.021,23.465,24.845,23.834,24.8L23.834,24.8z"/>' +
            "</svg>";
          break;
        default:
    ...
    function showNormalRating() {
      ...
      for (var i = 0; i < settings.count; i++) {
        ...
        shapes
          ...
          .find("stop")
          .eq(0)
          .attr({ "stop-color": settings.backgroundColor });
        shapes
          .eq(i)
          .find("#" + id + "_grad" + (i + 1))
          .find("stop")
    ...
    function showRating(rating) {
      ...
      if (settings.reverse) {
        for (var i = 0; i < rating; i++) {
          ...
          if (parseInt(rating) !== rating) {
            ...
            shapes
              ...
              .find("stop")
              .eq(0)
              .attr({ offset: 100 - ((rating * 10) % 10) * 10 + "%" });
            shapes
              .eq(k)
              .find("#" + id + "_grad" + (k + 1))
              .find("stop")
        ...
        for (var i = 0; i < rating; i++) {
          ...
          if ((rating * 10) % 10 > 0) {
            shapes
              .eq(Math.ceil(rating) - 1)
              .find("#" + id + "_grad" + (i + 1))
              .find("stop")
              .eq(0)
              .attr({ offset: ((rating * 10) % 10) * 10 + "%" });
            shapes
              .eq(Math.ceil(rating) - 1)
              .find("#" + id + "_grad" + (i + 1))
              .find("stop")
    ...
    var formulateNewColor = function (totalCount, currentVal) {
      ...
      for (var i = 0; i < 3; i++) {
        var diff = Math.round(
          (startColorCoords[i] - endColorCoords[i]) / totalCount
        );
    ...
    function onEnterOrClickEvent(e, ith, label, update) {
      ...
      var rating =
        ((settings.reverse ? settings.max - settings.min - ith + 1 : ith) -
          partial) *
        count;
...
(function (document, window, $) {
  ...
  $(document).ready(function () {
    ...
    $(window).bind("scroll", function () {
      if (
        (typeof navpos != undefined || navpos != null || navpos != "") &&
        $(window).scrollTop() > navpos.top
      ) {
        $(".navbar-default").addClass("navbar-fixed-top-vungtv");
      } else {
        $(".navbar-default").removeClass("navbar-fixed-top-vungtv");
      }
    });
  });
  $(document).ready(function () {
